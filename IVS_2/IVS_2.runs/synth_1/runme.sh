...
HD_PWD='C:/Vivado_project/IVS_2/IVS_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Master_SPI.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Master_SPI.tcl
