...
HD_PWD='C:/Vivado_project/JOB_projects/FIFO_sp_ram/FIFO_sp_ram.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_sp_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_sp_ram.tcl
