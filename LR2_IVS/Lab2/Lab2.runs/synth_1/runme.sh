...
HD_PWD='C:/Vivado_project/LR2_IVS/Lab2/Lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FPGA_Master.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FPGA_Master.tcl
