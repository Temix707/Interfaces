...
HD_PWD='C:/Vivado_project/JOB_projects/Sine_Taylor/Sine_Taylor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sine_taylor_shell.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sine_taylor_shell.tcl
