...
HD_PWD='C:/Vivado_project/JOB_projects/Sine_Taylor/Sine_Taylor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sine_taylor_shell.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sine_taylor_shell.tcl -notrace
