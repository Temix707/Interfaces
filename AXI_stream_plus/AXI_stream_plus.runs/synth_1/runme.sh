...
HD_PWD='C:/Vivado_project/AXI_stream_plus/AXI_stream_plus.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_stream_using_fifos.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXI_stream_using_fifos.tcl
