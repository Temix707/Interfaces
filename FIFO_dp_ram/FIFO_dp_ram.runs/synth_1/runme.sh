...
HD_PWD='C:/Vivado_project/JOB_projects/FIFO_dp_ram/FIFO_dp_ram.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_dp_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_dp_ram.tcl
