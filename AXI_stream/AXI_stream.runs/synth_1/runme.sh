...
HD_PWD='C:/Vivado_project/JOB_projects/AXI_stream/AXI_stream.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_stream_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXI_stream_top.tcl
